...
url='https://api.darksky.net/forecast/093d52ed6c084857cb6fdc14768f6478/'+latitude+','+longitude+'?units:si'
    request({url,json:true},(error,{body})=>{
        if(error){
            ...
            callback(undefined, 'Summary: '+body.daily.data[0].summary+' Temperature: '+body.currently.temperature+' Temperature Low: '+body.daily.data[0].temperatureLow+' Temperature High: '+body.daily.data[0].temperatureHigh+' Chance of rain: '+body.currently.precipProbability
            //     {
